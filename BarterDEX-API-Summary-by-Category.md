...
#### barterDEX Operation
[client](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#client), [client_osx](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#client_osx), [debug](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#debug), [disable](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#disable), [enable](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#enable), [getcoins](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#getcoins), [getpeers](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#getpeers), [getpeersIP](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#getpeersip), [help](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#help), [millis](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#millis), [notarizations](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#notarizations), [parselog](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#parselog), [run](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#run), [run_osx](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#run_osx), [setpassphrase](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#setpassphrase), [stop](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#stop), [trust](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#trust), [trusted](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#trusted)

#### barterDEX Trading
[autoprice](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#autoprice), [baserelswaps](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#baserelswaps), [bestfit](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#bestfit), [buy](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#buy), [coinswaps](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#coinswaps), [electrum](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#electrum), [getprices](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#getprices), [goal](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#goal), [goals](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#goals), [myprice](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#myprice), [myprices](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#myprices), [orderbook](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#orderbook), [pendings](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#pendings), [pendingswaps](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#pendingswaps), [portfolio](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#portfolio), [pubkeystats](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#pubkeystats), [recentswaps](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#recentswaps), [sell](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#sell), [setconfirms](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#setconfirms), [setprice](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#setprice), [status](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#status)

[> `autoprice` the value of a fund, ie. using the `fundvalue` api](https://github.com/KomodoPlatform/komodo/wiki/BarterDEX-API-Summary-by-Category#autoprice-the-value-of-a-fund-ie-using-the-fundvalue-api)

#### TradeBots
[bot_buy](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#bot_buy), [bot_list](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#bot_list), [bot_pause](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#bot_pause), [bot_resume](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#bot_resume), [bot_sell](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#bot_sell), [bot_settings](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#bot_settings), [bot_status](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#bot_status), [bot_stop](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#bot_stop)

#### Coin Wallet Features
[balance](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#balance), [balances](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#balances), [fundvalue](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#fundvalue), [getrawtransaction](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#getrawtransaction), [listunspent](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#listunspent), [secretaddresses](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#secreaddresses), [sendrawtransaction](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#sendrawtransaction), [KomodoPlatform](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#KomodoPlatform), [withdraw](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#withdraw)

#### Statistics
[guistats](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#guistats), [pricearray](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#pricearray), [statsdisp](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#statsdisp), [ticker](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#ticker), [tradesarray](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#tradesarray)

#### Communication
[deletemessages](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#deletemessages), [getmessages](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#getmessages), [message](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#message)

#### Revenue Sharing/Operations
[dividends](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#dividends), [snapshot](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#snapshot), [snapshot_balance](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#snapshot_balance), [snapshot_loop](https://github.com/KomodoPlatform/komodo/wiki/barterDEX-API-Summary-by-Category#snapshot_loop)

[InstantDEX swap](https://github.com/KomodoPlatform/komodo/wiki/Processing-InstantDEX-swap-on-barterDEX) - `deposit1` & `claim` 
...
#### electrum
This method enables a coin by connecting to the specified electrumx server. For this method running a native node is not necessary. You need to edit the file with coin name and IP address and port for the coin. For a list of electrumx server check this link `http://pad.KomodoPlatform.org/electrum-servers`
...
Sample Output:
```JSON
[{"coin":"BTC","balance":0.00400000}, {"coin":"KMD","balance":360.33996021}, {"coin":"MNZ","balance":55.70756040}, {"coin":"REVS","balance":39.10219798}, {"coin":"JUMBLR","balance":1.12038776}, {"coin":"KomodoPlatform","balance":0.91430900}, {"coin":"PANGEA","balance":1}, {"coin":"DEX","balance":1}, {"coin":"BET","balance":1}, {"coin":"CRYPTO","balance":1}, {"coin":"HODL","balance":1}, {"coin":"BOTS","balance":1}, {"coin":"COQUI","balance":10.85596031}]
```
...
#### KomodoPlatform
`KomodoPlatform` script uses the `balances` API and returs all KomodoPlatform aseet balances along with KMD for a specific address. In order for external addresses to work, you need to have `importaddress` and `rescan` done, for obvious reasons, in native mode. SPV mdoe just works without that.
...
Sample Output:
```JSON
[{"coin":"KMD","balance":6000000}, {"coin":"REVS","balance":6335.95500000}, {"coin":"JUMBLR","balance":239022.38900000}, {"coin":"KomodoPlatform","balance":6335.95500000}, {"coin":"PANGEA","balance":602828.14640000}, {"coin":"DEX","balance":257733}, {"coin":"BET","balance":2688}, {"coin":"CRYPTO","balance":320754.73700000}, {"coin":"HODL","balance":70000}, {"coin":"MSHARK","balance":385403.90000000}, {"coin":"BOTS","balance":288157}]
```
...
Sample Output:
```JSON
[{"timestamp":1513174486,"KMD":4.02827942,"CHIPS":80.00010000,"price":19.85962036}, {"timestamp":1513168630,"KMD":0.07448089,"MNZ":0.25609997,"price":3.43846549}, {"timestamp":1513166465,"CRYPTO":44.00844307,"KMD":500.00010000,"price":11.36145851}, {"timestamp":1513158008,"KMD":463.91820708,"KomodoPlatform":10.00010000,"price":0.02155574}]
```
